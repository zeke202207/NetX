...
public static class ServerHost
{
    ...
    public static void Start(RunOption options, string urls = "" , ServiceOption? serviceOption = null)
    {
        //获取命令行参数
        var args = Environment.GetCommandLineArgs().Skip(1).ToArray();
        if (Service.UseServiceSelf(args, serviceOption?.ServiceName, serviceOption?.Options))
        {
